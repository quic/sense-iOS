...
class InferenceLocal : NSObject {
    ...
    var model = realtimenet()
    
    var numFrames = -2
    var frames = [CVPixelBuffer]()
    var framesForPrediction = [CVPixelBuffer]()
    var cache_initialized = false
    var cachedOutputs0: realtimenetOutput? = nil
    var cachedOutputs1: realtimenetOutput? = nil
    ...
    private func init_cache() {
        ...
        cachedOutputs0 = realtimenetOutput.init(cnn_3_save_0: try! MLMultiArray(shape: [32,56,40], dataType: MLMultiArrayDataType.float32), cnn_3_save_1: try! MLMultiArray(shape: [32,56,40], dataType: MLMultiArrayDataType.float32), cnn_7_save_0: try! MLMultiArray(shape: [56,28,20], dataType: MLMultiArrayDataType.float32), cnn_11_save_0: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_11_save_1: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_14_save_0: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_17_save_0: try! MLMultiArray(shape: [160,14,10], dataType: MLMultiArrayDataType.float32), cnn_20_save_0: try! MLMultiArray(shape: [160,14,10], dataType: MLMultiArrayDataType.float32), cnn_23_save_0: try! MLMultiArray(shape: [272,7,5], dataType: MLMultiArrayDataType.float32), cnn_25_save_0: try! MLMultiArray(shape: [272,7,5], dataType: MLMultiArrayDataType.float32), output_globalclassifier: try! MLMultiArray(shape: [NSNumber(value: InferenceLocal.dimGlobalClassifier)], dataType: MLMultiArrayDataType.float32))
        
        cachedOutputs1 = realtimenetOutput.init(cnn_3_save_0: try! MLMultiArray(shape: [32,56,40], dataType: MLMultiArrayDataType.float32), cnn_3_save_1: try! MLMultiArray(shape: [32,56,40], dataType: MLMultiArrayDataType.float32), cnn_7_save_0: try! MLMultiArray(shape: [56,28,20], dataType: MLMultiArrayDataType.float32), cnn_11_save_0: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_11_save_1: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_14_save_0: try! MLMultiArray(shape: [112,14,10], dataType: MLMultiArrayDataType.float32), cnn_17_save_0: try! MLMultiArray(shape: [160,14,10], dataType: MLMultiArrayDataType.float32), cnn_20_save_0: try! MLMultiArray(shape: [160,14,10], dataType: MLMultiArrayDataType.float32), cnn_23_save_0: try! MLMultiArray(shape: [272,7,5], dataType: MLMultiArrayDataType.float32), cnn_25_save_0: try! MLMultiArray(shape: [272,7,5], dataType: MLMultiArrayDataType.float32), output_globalclassifier: try! MLMultiArray(shape: [NSNumber(value: InferenceLocal.dimGlobalClassifier)], dataType: MLMultiArrayDataType.float32))
}
    ...
    public func evaluateModelEfficientnet(frames: [CVPixelBuffer]) -> realtimenetOutput? {
